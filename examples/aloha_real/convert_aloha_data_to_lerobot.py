...
Append additional tasks: add --append and keep the same repo_id.
"""
...
def port_aloha(
    ...
    *,
    ...
    repo_path = "/mnt/8db2a567-4f07-490e-8f21-8de11a9b1521/aloha_dataset" / repo_id
    if repo_path.exists() and not append:
    ...
    if repo_path.exists() and append:
