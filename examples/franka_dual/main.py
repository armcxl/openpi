...
from examples.franka_dual import env as _env
...
class Args:
    ...
    arm_ids: tuple[str, str] = ("fr3_left", "fr3_right")

    cam_external: str = "/cam_external/image_raw"
    cam_left_wrist: str = "/cam_left_wrist/image_raw"
    cam_right_wrist: str = "/cam_right_wrist/image_raw"
...
def main(args: Args) -> None:
    ...
    camera_topics = {
        "cam_external": args.cam_external,
        "cam_left_wrist": args.cam_left_wrist,
        "cam_right_wrist": args.cam_right_wrist,
    }

    runtime = _runtime.Runtime(
        environment=_env.FrankaDualEnvironment(
            arm_ids=list(args.arm_ids),
